...
const TASK_SEQUENCES = [
    {
        status: "Scraping websites",
        lines: [
            "Navigating to target sites...",
    ...
    return (
        <div className="flex items-center justify-center min-h-full w-full">
            <div className="space-y-4 w-auto">
                <div className="ml-2 flex items-center space-x-2 text-muted-foreground font-medium">
                    <LoadingAnimation
                ...
                <div className="relative">
                    ...
                    >
                        <div>
                            {visibleLines.map((line, index) => (
                                ...
                                >
                                    <div className="text-muted-foreground pr-3 select-none w-6 text-right">
                                        {line.number}
                                    </div>

                                    <div className="text-foreground flex-1 ml-1">
                                        {line.text}
                                    </div>
                                </div>
                            ))}
                    ...
                    <div
                        ...
                        style={{
                            background:
                                "linear-gradient(to bottom, hsl(var(--background)) 0%, transparent 30%, transparent 100%)",
                        }}
                    />
                </div>
            </div>
